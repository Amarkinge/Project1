        ...
        <div id="left-side-form">
          ...
          { file? <div id="imgs-add-car-container">
            ...
            <div>
                ...
                <textarea className="car-detail-description" name="carDetails" placeholder="Add Bus Details.."  onChange={(e)=>setData({...data,carDetails:e.target.value})} value={carDetails}></textarea>
            </div>
            <div>
