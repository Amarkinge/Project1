...
export default function AdminPage() {
    ...
    <div id="admin-page-main-home">
        ...
        <div id="add-car">
            <h3 id="info">Buses</h3>
            {/* <Link to="/Existbookings" id="btuunt-concle-in-exsist-Booking"><button id="btn-add-car">Bookings</button></Link>  */}
          
          <Link to="/add-car-details" id="btn-add-car-link"><button id="btn-add-car">Add Bus</button></Link> 
        </div>
      ...
      <div id="main-container">
            {
                car.map((d, i) => {
                    return<> <div key={i} id="car-container">
                        ...
                        <div id="person-of-admin-page-in-my-page">45 person</div>
