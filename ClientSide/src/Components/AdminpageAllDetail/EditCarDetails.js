...
export default function EditCarDetails(){
 ...
 {TokenAdmin?<><AdminpageNav/>
   ...
   <h2 id="name-of-car-detail-edit"><i>Edit Bus Details</i></h2>
     ...
     <div id="main-container-of-form">
        <div id="left-side-form">
          ...
          { file? <div id="imgs-add-car-container">
            ...
            <div>
                <label>Bus Details</label><br/>
                <textarea className="car-detail-description" name="carDetails" placeholder="Add Bus Details.."  onChange={(e)=>setEdit({...edit,carDetails:e.target.value})} value={edit.carDetails}></textarea>
            </div>
            <div>
