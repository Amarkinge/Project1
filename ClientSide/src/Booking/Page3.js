...
{TokenUser?<>
  <NavLogout/>
    <div id="parent" >
    <h1 id="welcome">WELCOME TO BUS RENTAL SERVICE</h1>
<div id='container'>
...
<form id="forms" onSubmit={save}>
  ...
  <input type="date" placeholder='Starting Date' min="2023-09-01" className="Fields" required
     name="startDate" onChange={handleInput}></input>

  <input type="date" placeholder='End Date' min="2023-09-01"  className="Fields" required
